        ...
        <form method="POST" action="{{ route('site.webshop.checkout.store') }}" class="row">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-dark text-white font-weight-bold">A kosár tartalma</div>
                    <div class="card-body">
                        @foreach($items as $productId => $item)
                            <div class="d-flex align-items-center mb-3 pb-3 border-bottom ws-checkout-item" data-id="{{ $productId }}">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="h6 font-weight-bold mb-1">{{ $item['name'] }}</h5>
                                    @if(($ws['site_product_prices_visible'] ?? 'true') === 'true')
                                        <div class="text-muted small">Egységár: {{ hufFormat($item['price']) }}</div>
                                    @endif
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        ...
                                        <button type="button" class="btn btn-sm btn-link text-danger ml-3 js-remove-cart-item" data-id="{{ $productId }}" data-reload="true">
                                            <i class="fa fa-trash-alt mr-1"></i> Törlés
                                        </button>
                                    </div>
                                </div>
                                @if(($ws['site_product_prices_visible'] ?? 'true') === 'true')
                                    <div class="text-right font-weight-bold ml-3" style="min-width: 100px;">
                        ...
                        @if(($ws['site_product_prices_visible'] ?? 'true') === 'true')
                            <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top h4">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-header bg-primary text-white font-weight-bold">Személyes adatok</div>
                    <div class="card-body">
                        <div class="row">
